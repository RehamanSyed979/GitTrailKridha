  ...
  var e = {
      ...
      1970: function (e, t, n) {
        ...
        function eE({
          ...
          let { ixInstances: u, ixSession: a } = e.getState(),
            l = a.hasBoundaryNodes && n ? _.getClosestElement(n, h) : null;
          (0, f.default)(u, (n) => {
        ...
        function ep({
          ...
          let T = s.hasBoundaryNodes && n ? _.getClosestElement(n, h) : null,
            y = D(O),
            m = !1;
          return (
            O.forEach((o, c) => {
              ...
              p &&
                R({
                  ...
                  let O = w({ element: s, actionItem: o }),
                    T = P({ element: s, actionItem: o, elementApi: _ }, p);
                  eg({
                    store: e,
                    element: s,
                    actionItem: o,
        ...
        function eg(e) {
          let t,
            ...
            { refState: y } = p[T] || {},
            A = _.getRefType(u),
            m = I.reducedMotion && E.ReducedMotionTypes[o.actionTypeId];
          if (m && c)
          ...
          b({ store: n, select: ({ ixInstances: e }) => e[d], onChange: eO }),
        ...
        function e_(e, t) {
          ...
          let { elementId: n, actionItem: r } = e,
            ...
            { ref: u, refType: o } = i[n] || {};
          o === C && k(u, r, _), t.dispatch((0, g.instanceRemoved)(e.id));
        }
        function eI(e, t, n) {
        ...
        function eO(e, t) {
          let {
            ...
            { events: h } = A,
            { mediaQueries: S = A.mediaQueryKeys } = h && h[f] ? h[f] : {};
          if (X(S, m.mediaQueryKey) && (r || n || i)) {
            if (c || (l === N && i)) {
              t.dispatch((0, g.elementStateChanged)(u, a, c, o));
              let { ixElements: e } = t.getState(),
                { ref: n, refType: r, refState: i } = e[u] || {},
                s = i && i[a];
              (r === C || H(a)) && M(n, i, s, f, o, O, _, l, y);
            }
            if (i) {
              if (I) {
                let e = ep({
      ...
      8955: function (e, t, n) {
        ...
        let {
          ...
          eE = {
            ...
            [L]: { types: "ecommerce-cart-close", handler: Q(x, $) },
            [d]: {
              types: "click",
              handler: Q(
                x,
      ...
      7718: function (e, t, n) {
        ...
        let r = n(7087),
          ...
          T = (e, t) => {
            ...
            return (0, u.merge)(e, { position: C, current: S });
          },
          y = (e, t) => {
            let {
                active: n,
      ...
      4124: function (e, t, n) {
        ...
        let {
          ...
          ea = (e) => e.trim(),
          el = Object.freeze({ [en]: v, [er]: M, [ei]: L }),
          ec = Object.freeze({
        ...
        function ey({
          ...
          let S = (t?.action?.config?.affectedElements ?? {})[y || m] || {},
            R = !!(S.id || S.selector),
            F = t && f(eT(t.target));
          if (
            (R
              ? ((u = S.limitAffectedElements), (o = F), (a = f(S)))
              : (o = a = f({ id: y, selector: m, selectorGuids: h })),
            t && N)
          ) {
            let e = n && (a || !0 === N) ? [n] : d(F);
            if (a) {
        ...
        function eN(e, t = {}, n = {}, r, i) {
          ...
          switch (r.actionTypeId) {
            ...
            case Z:
              return { value: (0, u.default)(parseFloat(o(e, S)), 1) };
            case et: {
              let t,
                i = o(e, P),
                a = o(e, b);
          ...
          switch (l) {
            case x:
              ...
              let I = eV
                  ...
                  .join(" "),
                { setStyle: S } = _;
              eX(s, p.TRANSFORM_PREFIXED, _),
                S(s, p.TRANSFORM_PREFIXED, I),
                (function (
                  { actionTypeId: e },
                ...
                })(g, d) && S(s, p.TRANSFORM_STYLE_PREFIXED, C);
              return;
            case H:
              return (function (e, t, n, r, i, u) {
                ...
                switch (r.actionTypeId) {
                  case et: {
                    ...
                    void 0 !== o &&
                      (t === X && (t = "px"), eX(e, P, u), a(e, P, o + t)),
                      void 0 !== l &&
                        (i === X && (i = "px"), eX(e, b, u), a(e, b, l + i));
                    break;
                  }
                  case J:
                    var l = r.config;
        ...
        function eX(e, t, n) {
          ...
          -1 === a.indexOf(r) && u(e, B, a.concat(r).join(k));
        }
        function ek(e, t, n) {
          if (!p.IS_BROWSER_ENV) return;
          let r = ec[t];
        ...
        function eY(e, t, n) {
          ...
          i(e, B) && eH({ effect: ek, actionTypeId: u, elementApi: n })(e);
        }
        let eH =
            ...
            switch (t.type) {
              ...
              case T: {
                let {
                  ...
                  c = e;
                return (
                  (0, u.getIn)(c, [n, r]) !== r && (c = h(c, r, a, n, o)),
                  C(c, n, l, i, o)
                );
              }
              case y: {
        ...
        Webflow.require("ix2").init({
          events: {
            e: {
              ...
              target: {
                id: "685ecadea503f898591d3ec8|6d79357e-54f0-1c4f-c171-1bac56acab95",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-3": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "685ecadea503f898591d3ec8|6d79357e-54f0-1c4f-c171-1bac56acabae",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
